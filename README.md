...
MVP limitations: no daemon, no background monitoring, no remote hosts, no log/container-specific collectors yet, limited service-manager coverage, no redacted export mode yet, and no mutating actions.
