...
**Created:** 2026-09-03
**Status:** Proposed — **design sketch** (commitment tiers in §0). Early slices are code-grounded and implementation-ready; later slices are design intent to validate against real data from the early ones.
