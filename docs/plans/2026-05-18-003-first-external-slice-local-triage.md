...
**Addendum:** 2026-05-22 — addressed the high-priority technical review findings and bumped package metadata to v0.0.31: container commands are redacted/bounded with metadata, empty-assistant/no-tool triage now degrades through deterministic precollection, empty-evidence fallback wording no longer claims evidence exists, and Linux validation briefs now avoid raw external snapshots and isolate optional credentialed runs under disposable XDG paths.
**Addendum:** 2026-05-23 — Linux validation results were reviewed and summarized in `docs/reviews/2026-05-23-linux-validation-summary.md`: public v0.0.30 direct collector/package validation passed on Ubuntu 24.04 ARM64, Debian 13 ARM64, Fedora 42 ARM64, and Debian 13 x86_64. Credentialed triage was skipped, and v0.0.31 review-finding fixes still need a shorter public rerun after push.
