...
- [x] Add a tag-triggered Buildkite release pipeline/script for signing/notarization inside Tart using ephemeral guest-local keychain material and the Lightless-Labs `tart-ci` fork env passthrough.
