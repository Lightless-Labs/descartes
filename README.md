...
MVP limitations: no daemon, no background monitoring, no remote hosts, no container-specific collectors yet, limited service-manager/log coverage, no redacted export mode yet, and no mutating actions.
