...
**Target:** Linux systemd-user daemon lifecycle validation for Descartes `v0.0.40+`
...
- `descartes --version` is `0.0.40` or newer.
...
- Public GitHub install works and version is `0.0.40+`.
