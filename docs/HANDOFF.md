...
Current session update: applied the working GitHub Actions notarization keychain pattern from https://github.com/IronsideXXVI/Hacker-News to the Descartes macOS notifier Buildkite release scripts. Key changes:
