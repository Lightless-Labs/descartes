...
- **Slice 1 — the SPIKE (thin vertical slice → written go/no-go).** Dedicated plan: `docs/plans/2026-09-03-slice-1-behavioral-model-spike.md`. One end-to-end path, no framework:
